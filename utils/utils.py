...
def check_anchors(dataset, model, thr=4.0, imgsz=640):
    ...
    m = model.module.student.detect if hasattr(model, 'module') else model.student.detect  # Detect()
...
def build_targets(p, targets, model):
    ...
    det = model.module.detect if type(model) in (nn.parallel.DataParallel, nn.parallel.DistributedDataParallel) \
        else model.detect # Detect() module
