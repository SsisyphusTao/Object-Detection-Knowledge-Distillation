    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        with torch.no_grad():
            ...
            if training:  # if model has loss hyperparameters
                loss += compute_loss([train_out[x].float() for x in train_out], targets, model)[1][:3]  # GIoU, obj, cls
...
if __name__ == '__main__':
    ...
    parser.add_argument('--conf-thres', type=float, default=0.4, help='object confidence threshold')  # original 0.001
